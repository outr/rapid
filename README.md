...
### Core
```scala
libraryDependencies += "com.outr" %% "rapid-core" % "2.9.2"
```

### Test (Test features for running Task effects in ScalaTest)
```scala
libraryDependencies += "com.outr" %% "rapid-test" % "2.9.2"
```

### Cats (Interoperability with Cats-Effect)
```scala
libraryDependencies += "com.outr" %% "rapid-cats" % "2.9.2"
```
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x000000009b8f4000@3849d0c4,
...
//   input = FlatMap(
//     input = Unit,
//     f = rapid.Task$$Lambda/0x000000009b8f3bf0@69b8b855,
//     trace = SourcecodeTrace(
//       file = File("README.md"),
//       line = Line(20),
...
//     )
//   ),
//   f = rapid.Task$$Lambda/0x000000009b8f57c8@219d9cab,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(20),
//     enclosing = Enclosing("repl.MdocSession.MdocApp#delayed"),
...
// fiber: Fiber[String] = rapid.fiber.VirtualThreadFiber@699e1c60
...
// s: Stream[Int] = rapid.Stream@6768cdd7
...
// base: Stream[Int] = rapid.Stream@1596f3b9
...
//   stream = rapid.Stream@1596f3b9,
//   forge = repl.MdocSession$MdocApp$$anon$25@40b624ba,
//   maxThreads = 8,
//   maxBuffer = 100000
// )
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x000000009b91a8f8@4ad1ac79,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(180),
