...
### Core
```scala
libraryDependencies += "com.outr" %% "rapid-core" % "2.3.2"
```

### Scribe (Effects for Logging)
```scala
libraryDependencies += "com.outr" %% "rapid-scribe" % "2.3.2"
```

### Test (Test features for running Task effects in ScalaTest)
```scala
libraryDependencies += "com.outr" %% "rapid-test" % "2.3.2"
```

### Cats (Interoperability with Cats-Effect)
```scala
libraryDependencies += "com.outr" %% "rapid-cats" % "2.3.2"
```
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x0000000056558400@5b727120,
...
//   input = FlatMap(
//     input = Unit,
//     f = rapid.Task$$Lambda/0x000000005655afc8@5cef2412,
//     trace = SourcecodeTrace(
//       file = File("README.md"),
//       line = Line(20),
...
//     )
//   ),
//   f = rapid.Task$$Lambda/0x000000005655bb78@4960c6a4,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(20),
//     enclosing = Enclosing("repl.MdocSession.MdocApp#delayed")
...
//   Suspend(
//     f = repl.MdocSession$MdocApp$$Lambda/0x0000000056559c78@11752fa3,
//     trace = SourcecodeTrace(
//       file = File("README.md"),
//       line = Line(42),
...
// s: Stream[Int] = rapid.Stream@f4185312
...
// base: Stream[Int] = rapid.Stream@7e3cba46
...
//   stream = rapid.Stream@7e3cba46,
//   forge = repl.MdocSession$MdocApp$$anon$25@11ef026d,
//   maxThreads = 8,
//   maxBuffer = 100000
// )
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x000000005657da28@751fc729,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(177),
