...
### Core
```scala
libraryDependencies += "com.outr" %% "rapid-core" % "2.9.1"
```

### Test (Test features for running Task effects in ScalaTest)
```scala
libraryDependencies += "com.outr" %% "rapid-test" % "2.9.1"
```

### Cats (Interoperability with Cats-Effect)
```scala
libraryDependencies += "com.outr" %% "rapid-cats" % "2.9.1"
```
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x000000001c8e9000@54243fcb,
...
//   input = FlatMap(
//     input = Unit,
//     f = rapid.Task$$Lambda/0x000000001c8f19b8@21a24657,
//     trace = SourcecodeTrace(
//       file = File("README.md"),
//       line = Line(20),
...
//     )
//   ),
//   f = rapid.Task$$Lambda/0x000000001c8f2560@2da1336a,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(20),
//     enclosing = Enclosing("repl.MdocSession.MdocApp#delayed"),
...
// fiber: Fiber[String] = rapid.fiber.VirtualThreadFiber@72b2fb64
...
// s: Stream[Int] = rapid.Stream@65671b5
...
// base: Stream[Int] = rapid.Stream@53218d5e
...
//   stream = rapid.Stream@53218d5e,
//   forge = repl.MdocSession$MdocApp$$anon$25@1e81c52b,
//   maxThreads = 8,
//   maxBuffer = 100000
// )
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x000000001c913318@2647f09,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(180),
