...
### Core
```scala
libraryDependencies += "com.outr" %% "rapid-core" % "2.9.3"
```

### Test (Test features for running Task effects in ScalaTest)
```scala
libraryDependencies += "com.outr" %% "rapid-test" % "2.9.3"
```

### Cats (Interoperability with Cats-Effect)
```scala
libraryDependencies += "com.outr" %% "rapid-cats" % "2.9.3"
```
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x00000000158fc5c0@76406749,
...
//   input = FlatMap(
//     input = Unit,
//     f = rapid.Task$$Lambda/0x00000000158fd8c8@5be8d02b,
//     trace = SourcecodeTrace(
//       file = File("README.md"),
//       line = Line(20),
...
//     )
//   ),
//   f = rapid.Task$$Lambda/0x0000000015904598@6b694d72,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(20),
//     enclosing = Enclosing("repl.MdocSession.MdocApp#delayed"),
...
// fiber: Fiber[String] = rapid.fiber.VirtualThreadFiber@5d89cca0
...
// s: Stream[Int] = rapid.Stream@5fc85594
...
// base: Stream[Int] = rapid.Stream@556d349a
...
//   stream = rapid.Stream@556d349a,
//   forge = repl.MdocSession$MdocApp$$anon$25@68321a9d,
//   maxThreads = 8,
//   maxBuffer = 100000
// )
...
//   f = repl.MdocSession$MdocApp$$Lambda/0x000000001592cd70@4a188f21,
//   trace = SourcecodeTrace(
//     file = File("README.md"),
//     line = Line(180),
